model = dict(
    ...
    backbone=dict(
        ...
        plugins=[
            dict(
                cfg=dict(type='ReceptiveFieldAttention'),
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint=
            '/data/home/scv6681/run/project/mmdetection/work_dirs/resnet50_rf/model_r50_rf.pth.tar'
        )),
    neck=dict(
        type='FPN',
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='/data/public/coco2017/annotations/instances_train2017.json',
...
auto_resume = False
gpu_ids = range(0, 8)
# work_dir = './work_dirs/pretrained_whole_coco_faster_rcnn_r50_rf_fpn_1x_coco'
