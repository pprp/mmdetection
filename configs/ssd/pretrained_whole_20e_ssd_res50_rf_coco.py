...
# optimizer
# optimizer = dict(type='SGD', lr=0.015, momentum=0.9, weight_decay=4.0e-5) # for 8 GPUS
optimizer = dict(type='SGD', lr=0.0075, momentum=0.9, weight_decay=4.0e-5) # for 4 GPUS 
